...
export default function App() {
  ...
  const [iconRight, setIconRight] = useState(20);
  ...
  useEffect(() => {
    const updateIconAlignment = () => {
      if (window.innerWidth >= 1024 && imageSectionRef.current) {
        const rect = imageSectionRef.current.getBoundingClientRect();
        setIconRight(Math.max(20, window.innerWidth - rect.right));
        return;
      }
      setIconRight(20);
    };
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-start justify-start gap-16 lg:flex-row lg:gap-40">
          ...
          <div className="flex w-full flex-col justify-between lg:min-h-[433px] lg:max-w-xl">
            <div className="space-y-8">
              ...
              >
                ...
                <div className="relative pl-4">
                  ...
                  />
                  <p><a href="https://x.com/jayshharma/status/2018424623902187832" target="_blank" rel="noreferrer" className="underline transition-opacity hover:opacity-80">Vignette</a> - A quicker discovery engine for Pinterest.</p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <a
                href="mailto:sharmj28@mcmaster.ca"
                className="transition-opacity hover:opacity-80"
              >
                Email
              </a>
              ...
              <a
                href="https://github.com/jayshharma"
                target="_blank"
                rel="noreferrer"
                className="transition-opacity hover:opacity-80"
              >
          ...
          <div ref={imageSectionRef} className="w-full flex-shrink-0 lg:w-auto">
            <div className="relative w-full lg:w-[325px]">
              <img src={imgProfile} alt="Jay Sharma" className="h-auto w-full object-cover" />
            </div>
            <div
